...
; GFX7-NEXT:    v_mul_lo_u32 v5, v2, v5
; GFX7-NEXT:    v_add_i32_e32 v1, vcc, v9, v10
; GFX7-NEXT:    v_mad_u64_u32 v[9:10], s[4:5], v2, v4, 0
; GFX7-NEXT:    v_mul_lo_u32 v12, v3, v4
; GFX7-NEXT:    v_add_i32_e32 v11, vcc, v1, v0
; GFX7-NEXT:    v_add_i32_e32 v0, vcc, 4, v6
; GFX7-NEXT:    v_addc_u32_e32 v1, vcc, 0, v7, vcc
; GFX7-NEXT:    v_add_i32_e32 v3, vcc, v10, v5
; GFX7-NEXT:    v_add_i32_e32 v3, vcc, v3, v12
; GFX7-NEXT:    flat_store_dword v[6:7], v8
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_add_i32_e32 v8, vcc, v8, v9
; GFX7-NEXT:    v_addc_u32_e32 v9, vcc, v11, v3, vcc
...
; GFX12-NEXT:    s_wait_bvhcnt 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_mul_lo_u32 v10, v1, v4
; GFX12-NEXT:    v_mul_lo_u32 v11, v0, v5
; GFX12-NEXT:    v_mad_co_u64_u32 v[0:1], null, v0, v4, 0
; GFX12-NEXT:    v_mul_lo_u32 v12, v3, v4
...
; GFX12-NEXT:    v_add3_u32 v1, v1, v11, v10
; GFX12-NEXT:    v_add3_u32 v3, v9, v5, v12
...
; GFX12-NEXT:    v_add_co_ci_u32_e64 v9, null, v1, v3, vcc_lo
; GFX12-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX12-NEXT:    v_mad_co_u64_u32 v[2:3], null, v2, v4, v[8:9]
; GFX12-NEXT:    v_add3_u32 v3, v12, v3, v5
; GFX12-NEXT:    s_wait_storecnt 0x0
...
; GFX7-NEXT:    v_mul_u32_u24_e32 v5, v0, v2
