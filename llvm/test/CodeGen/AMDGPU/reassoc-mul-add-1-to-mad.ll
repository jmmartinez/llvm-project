...
; GFX900-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], v0, s0, v[0:1]
; GFX900-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], v1, v0, v[1:2]
; GFX900-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x0
; GFX900-NEXT:    v_mad_u64_u32 v[3:4], s[6:7], v2, v1, v[2:3]
; GFX900-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x10
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-NEXT:    s_load_dword s9, s[2:3], 0x4
; GFX900-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], v3, v2, v[3:4]
; GFX900-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GFX900-NEXT:    s_waitcnt lgkmcnt(0)
; GFX900-NEXT:    s_and_b32 s4, s9, 0xffff
; GFX900-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], v1, v3, v[1:2]
; GFX900-NEXT:    s_mul_i32 s8, s8, s4
; GFX900-NEXT:    v_mov_b32_e32 v6, s1
; GFX900-NEXT:    v_mad_u64_u32 v[3:4], s[2:3], v2, v1, v[2:3]
; GFX900-NEXT:    v_add_u32_e32 v4, s8, v0
; GFX900-NEXT:    v_mov_b32_e32 v5, s7
; GFX900-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], v3, v2, v[3:4]
; GFX900-NEXT:    v_add_co_u32_e32 v1, vcc, s0, v4
; GFX900-NEXT:    v_addc_co_u32_e32 v2, vcc, 0, v6, vcc
; GFX900-NEXT:    v_lshlrev_b64 v[1:2], 2, v[1:2]
; GFX900-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], v0, v3, v[0:1]
; GFX900-NEXT:    v_add_co_u32_e32 v0, vcc, s6, v1
; GFX900-NEXT:    v_addc_co_u32_e32 v1, vcc, v5, v2, vcc
...
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v0, s9, v[0:1]
; GFX90A-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v0, v[2:3]
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v2, v[4:5]
; GFX90A-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v4, v[2:3]
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[4:5], v4, v2, v[4:5]
; GFX90A-NEXT:    v_mad_u64_u32 v[4:5], s[4:5], v2, v4, v[2:3]
; GFX90A-NEXT:    s_load_dword s4, s[2:3], 0x4
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], v4, v2, v[4:5]
; GFX90A-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GFX90A-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], v2, v4, v[2:3]
; GFX90A-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NEXT:    s_and_b32 s2, s4, 0xffff
; GFX90A-NEXT:    s_mul_i32 s8, s8, s2
; GFX90A-NEXT:    v_add_u32_e32 v0, s8, v0
...
; GFX90A-NEXT:    v_add_co_u32_e32 v0, vcc, s6, v0
...
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], null, v0, s6, v[0:1]
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[0:1], 0x0
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], null, v1, v0, v[1:2]
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], null, v2, v1, v[2:3]
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_and_b32 s2, s2, 0xffff
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], null, v3, v2, v[3:4]
; GFX10-NEXT:    v_mad_u64_u32 v[2:3], null, v1, v3, v[1:2]
; GFX10-NEXT:    v_mad_u64_u32 v[3:4], null, s8, s2, v[0:1]
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v2, v1, v[2:3]
; GFX10-NEXT:    v_add_co_u32 v3, s0, s0, v3
; GFX10-NEXT:    v_add_co_ci_u32_e64 v4, null, s1, 0, s0
; GFX10-NEXT:    v_mad_u64_u32 v[1:2], null, v0, v2, v[0:1]
; GFX10-NEXT:    v_lshlrev_b64 v[2:3], 2, v[3:4]
; GFX10-NEXT:    v_mad_u64_u32 v[0:1], null, v1, v0, v[1:2]
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_mad_u32 v1, v0, s10, v0
...
; GFX1250-NEXT:    v_mad_u32 v2, v1, v0, v1
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    v_mad_u32 v2, v1, v2, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_mad_u32 v1, v2, v1, v2
; GFX1250-NEXT:    v_mad_u32 v2, v1, v2, v1
; GFX1250-NEXT:    s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)
; GFX1250-NEXT:    v_mad_u32 v3, v2, v1, v2
