...
; SDAG-GFX942-NEXT:    v_mov_b32_e32 v56, s1
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[0:3], v56, s[4:7], 0 offen
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[4:7], v56, s[4:7], 0 offen offset:16
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[8:11], v56, s[4:7], 0 offen offset:32
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[12:15], v56, s[4:7], 0 offen offset:48
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[16:19], v56, s[4:7], 0 offen offset:64
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[20:23], v56, s[4:7], 0 offen offset:80
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[24:27], v56, s[4:7], 0 offen offset:96
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[28:31], v56, s[4:7], 0 offen offset:112
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[32:35], v56, s[4:7], 0 offen offset:128
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[36:39], v56, s[4:7], 0 offen offset:144
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[40:43], v56, s[4:7], 0 offen offset:160
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[44:47], v56, s[4:7], 0 offen offset:176
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[48:51], v56, s[4:7], 0 offen offset:192
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[52:55], v56, s[4:7], 0 offen offset:208
; SDAG-GFX942-NEXT:    s_add_i32 s2, s8, s16
; SDAG-GFX942-NEXT:    v_mov_b32_e32 v57, s2
; SDAG-GFX942-NEXT:    s_addk_i32 s16, 0x100
; SDAG-GFX942-NEXT:    s_cmpk_lt_u32 s16, 0x2000
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(13)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[0:3], v57, s[12:15], 0 offen
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[0:3], v56, s[4:7], 0 offen offset:224
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(14)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[4:7], v57, s[12:15], 0 offen offset:16
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[4:7], v56, s[4:7], 0 offen offset:240
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[8:11], v57, s[12:15], 0 offen offset:32
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[12:15], v57, s[12:15], 0 offen offset:48
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[16:19], v57, s[12:15], 0 offen offset:64
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[20:23], v57, s[12:15], 0 offen offset:80
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[24:27], v57, s[12:15], 0 offen offset:96
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[28:31], v57, s[12:15], 0 offen offset:112
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[32:35], v57, s[12:15], 0 offen offset:128
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[36:39], v57, s[12:15], 0 offen offset:144
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[40:43], v57, s[12:15], 0 offen offset:160
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[44:47], v57, s[12:15], 0 offen offset:176
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[48:51], v57, s[12:15], 0 offen offset:192
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[52:55], v57, s[12:15], 0 offen offset:208
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(14)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[0:3], v57, s[12:15], 0 offen offset:224
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(13)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[4:7], v57, s[12:15], 0 offen offset:240
...
; GISEL-GFX942-NEXT:    v_add_u32_e32 v58, s0, v1
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[2:5], v58, s[8:11], 0 offen
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[6:9], v58, s[8:11], 0 offen offset:16
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[10:13], v58, s[8:11], 0 offen offset:32
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[14:17], v58, s[8:11], 0 offen offset:48
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[18:21], v58, s[8:11], 0 offen offset:64
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[22:25], v58, s[8:11], 0 offen offset:80
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[26:29], v58, s[8:11], 0 offen offset:96
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[30:33], v58, s[8:11], 0 offen offset:112
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[34:37], v58, s[8:11], 0 offen offset:128
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[38:41], v58, s[8:11], 0 offen offset:144
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[42:45], v58, s[8:11], 0 offen offset:160
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[46:49], v58, s[8:11], 0 offen offset:176
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[50:53], v58, s[8:11], 0 offen offset:192
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[54:57], v58, s[8:11], 0 offen offset:208
; GISEL-GFX942-NEXT:    v_add_u32_e32 v59, s12, v1
...
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v59, s[4:7], 0 offen
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[2:5], v58, s[8:11], 0 offen offset:224
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(14)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v59, s[4:7], 0 offen offset:16
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[6:9], v58, s[8:11], 0 offen offset:240
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[10:13], v59, s[4:7], 0 offen offset:32
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[14:17], v59, s[4:7], 0 offen offset:48
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[18:21], v59, s[4:7], 0 offen offset:64
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[22:25], v59, s[4:7], 0 offen offset:80
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[26:29], v59, s[4:7], 0 offen offset:96
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[30:33], v59, s[4:7], 0 offen offset:112
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[34:37], v59, s[4:7], 0 offen offset:128
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[38:41], v59, s[4:7], 0 offen offset:144
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[42:45], v59, s[4:7], 0 offen offset:160
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[46:49], v59, s[4:7], 0 offen offset:176
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[50:53], v59, s[4:7], 0 offen offset:192
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[54:57], v59, s[4:7], 0 offen offset:208
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(14)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v59, s[4:7], 0 offen offset:224
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(13)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v59, s[4:7], 0 offen offset:240
...
; SDAG-GFX942-NEXT:    v_add_u32_e32 v58, s8, v0
; SDAG-GFX942-NEXT:    v_add_co_u32_e32 v0, vcc, 0x100, v0
; SDAG-GFX942-NEXT:    s_and_b64 vcc, exec, vcc
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(13)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v58, s[12:15], 0 offen
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[2:5], v1, s[4:7], 0 offen offset:224
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(14)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v58, s[12:15], 0 offen offset:16
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[6:9], v1, s[4:7], 0 offen offset:240
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[10:13], v58, s[12:15], 0 offen offset:32
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[14:17], v58, s[12:15], 0 offen offset:48
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[18:21], v58, s[12:15], 0 offen offset:64
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[22:25], v58, s[12:15], 0 offen offset:80
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[26:29], v58, s[12:15], 0 offen offset:96
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[30:33], v58, s[12:15], 0 offen offset:112
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[34:37], v58, s[12:15], 0 offen offset:128
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[38:41], v58, s[12:15], 0 offen offset:144
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[42:45], v58, s[12:15], 0 offen offset:160
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[46:49], v58, s[12:15], 0 offen offset:176
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[50:53], v58, s[12:15], 0 offen offset:192
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(15)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[54:57], v58, s[12:15], 0 offen offset:208
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(14)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v58, s[12:15], 0 offen offset:224
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(13)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v58, s[12:15], 0 offen offset:240
...
; GISEL-GFX942-NEXT:    v_add_u32_e32 v58, s12, v0
...
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(13)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v58, s[4:7], 0 offen
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[2:5], v1, s[8:11], 0 offen offset:224
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(14)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v58, s[4:7], 0 offen offset:16
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[6:9], v1, s[8:11], 0 offen offset:240
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[10:13], v58, s[4:7], 0 offen offset:32
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[14:17], v58, s[4:7], 0 offen offset:48
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[18:21], v58, s[4:7], 0 offen offset:64
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[22:25], v58, s[4:7], 0 offen offset:80
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[26:29], v58, s[4:7], 0 offen offset:96
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[30:33], v58, s[4:7], 0 offen offset:112
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[34:37], v58, s[4:7], 0 offen offset:128
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[38:41], v58, s[4:7], 0 offen offset:144
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[42:45], v58, s[4:7], 0 offen offset:160
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[46:49], v58, s[4:7], 0 offen offset:176
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[50:53], v58, s[4:7], 0 offen offset:192
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(15)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[54:57], v58, s[4:7], 0 offen offset:208
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(14)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[2:5], v58, s[4:7], 0 offen offset:224
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(13)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[6:9], v58, s[4:7], 0 offen offset:240
...
; SDAG-GFX942-NEXT:    v_mov_b32_e32 v8, s0
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[0:3], v8, s[8:11], 0 offen
; SDAG-GFX942-NEXT:    buffer_load_dwordx4 v[4:7], v8, s[8:11], 0 offen offset:16
; SDAG-GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x44
; SDAG-GFX942-NEXT:    s_load_dword s13, s[4:5], 0x54
; SDAG-GFX942-NEXT:    s_mov_b32 s5, s12
; SDAG-GFX942-NEXT:    s_mov_b32 s9, s12
; SDAG-GFX942-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX942-NEXT:    s_mov_b32 s4, s3
...
; SDAG-GFX942-NEXT:    s_mov_b32 s13, s2
; SDAG-GFX942-NEXT:    v_mov_b32_e32 v8, s0
; SDAG-GFX942-NEXT:    s_or_b64 s[4:5], s[8:9], s[12:13]
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(1)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[0:3], v8, s[4:7], 0 offen
; SDAG-GFX942-NEXT:    s_waitcnt vmcnt(1)
; SDAG-GFX942-NEXT:    buffer_store_dwordx4 v[4:7], v8, s[4:7], 0 offen offset:16
; SDAG-GFX942-NEXT:    s_endpgm
;
...
; SDAG-GFX1100-NEXT:    buffer_load_b128 v[4:7], v4, s[8:11], 0 offen offset:16
; SDAG-GFX1100-NEXT:    s_clause 0x1
...
; SDAG-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; SDAG-GFX1100-NEXT:    s_mov_b32 s4, s3
; SDAG-GFX1100-NEXT:    v_mov_b32_e32 v8, s0
; SDAG-GFX1100-NEXT:    s_mov_b32 s8, s1
; SDAG-GFX1100-NEXT:    s_or_b64 s[6:7], s[4:5], s[12:13]
; SDAG-GFX1100-NEXT:    s_mov_b32 s13, s2
; SDAG-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; SDAG-GFX1100-NEXT:    s_or_b64 s[4:5], s[8:9], s[12:13]
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(1)
; SDAG-GFX1100-NEXT:    buffer_store_b128 v[0:3], v8, s[4:7], 0 offen
; SDAG-GFX1100-NEXT:    s_waitcnt vmcnt(0)
; SDAG-GFX1100-NEXT:    buffer_store_b128 v[4:7], v8, s[4:7], 0 offen offset:16
; SDAG-GFX1100-NEXT:    s_endpgm
;
...
; GISEL-GFX942-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX942-NEXT:    s_or_b64 s[10:11], s[6:7], s[10:11]
; GISEL-GFX942-NEXT:    v_mov_b32_e32 v8, s0
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[0:3], v8, s[8:11], 0 offen
; GISEL-GFX942-NEXT:    buffer_load_dwordx4 v[4:7], v8, s[8:11], 0 offen offset:16
; GISEL-GFX942-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x44
; GISEL-GFX942-NEXT:    s_load_dword s9, s[4:5], 0x54
; GISEL-GFX942-NEXT:    s_mov_b32 s4, s7
; GISEL-GFX942-NEXT:    s_mov_b32 s8, s7
; GISEL-GFX942-NEXT:    s_waitcnt lgkmcnt(0)
...
; GISEL-GFX942-NEXT:    s_mov_b32 s6, s1
; GISEL-GFX942-NEXT:    v_mov_b32_e32 v8, s0
; GISEL-GFX942-NEXT:    s_or_b64 s[0:1], s[6:7], s[4:5]
; GISEL-GFX942-NEXT:    s_mov_b32 s6, s3
; GISEL-GFX942-NEXT:    s_or_b64 s[2:3], s[6:7], s[8:9]
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(1)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[0:3], v8, s[0:3], 0 offen
; GISEL-GFX942-NEXT:    s_waitcnt vmcnt(1)
; GISEL-GFX942-NEXT:    buffer_store_dwordx4 v[4:7], v8, s[0:3], 0 offen offset:16
; GISEL-GFX942-NEXT:    s_endpgm
;
...
; GISEL-GFX1100-NEXT:    s_load_b128 s[0:3], s[4:5], 0x24
; GISEL-GFX1100-NEXT:    s_load_b32 s7, s[4:5], 0x34
; GISEL-GFX1100-NEXT:    s_mov_b32 s9, 0
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_mov_b32 s10, s9
; GISEL-GFX1100-NEXT:    s_mov_b32 s6, s9
; GISEL-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX1100-NEXT:    s_mov_b32 s8, s1
; GISEL-GFX1100-NEXT:    s_mov_b32 s11, s2
; GISEL-GFX1100-NEXT:    v_mov_b32_e32 v4, s0
; GISEL-GFX1100-NEXT:    s_or_b64 s[0:1], s[8:9], s[10:11]
; GISEL-GFX1100-NEXT:    s_mov_b32 s8, s3
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_or_b64 s[2:3], s[8:9], s[6:7]
; GISEL-GFX1100-NEXT:    s_clause 0x1
; GISEL-GFX1100-NEXT:    buffer_load_b128 v[0:3], v4, s[0:3], 0 offen
; GISEL-GFX1100-NEXT:    buffer_load_b128 v[4:7], v4, s[0:3], 0 offen offset:16
; GISEL-GFX1100-NEXT:    s_clause 0x1
; GISEL-GFX1100-NEXT:    s_load_b128 s[0:3], s[4:5], 0x44
; GISEL-GFX1100-NEXT:    s_load_b32 s5, s[4:5], 0x54
; GISEL-GFX1100-NEXT:    s_mov_b32 s4, s9
; GISEL-GFX1100-NEXT:    s_waitcnt lgkmcnt(0)
; GISEL-GFX1100-NEXT:    s_mov_b32 s7, s2
; GISEL-GFX1100-NEXT:    s_mov_b32 s8, s1
; GISEL-GFX1100-NEXT:    v_mov_b32_e32 v8, s0
; GISEL-GFX1100-NEXT:    s_or_b64 s[0:1], s[8:9], s[6:7]
; GISEL-GFX1100-NEXT:    s_mov_b32 s8, s3
; GISEL-GFX1100-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GISEL-GFX1100-NEXT:    s_or_b64 s[2:3], s[8:9], s[4:5]
; GISEL-GFX1100-NEXT:    s_waitcnt vmcnt(1)
; GISEL-GFX1100-NEXT:    buffer_store_b128 v[0:3], v8, s[0:3], 0 offen
; GISEL-GFX1100-NEXT:    s_waitcnt vmcnt(0)
; GISEL-GFX1100-NEXT:    buffer_store_b128 v[4:7], v8, s[0:3], 0 offen offset:16
; GISEL-GFX1100-NEXT:    s_endpgm
